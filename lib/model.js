module.exports = (function() {
  ...
  Input.shapes = {
    ...
    color: SVG.roundedCornerRect,
    dropdown: SVG.roundedCornerRect,
  ...
  Input.prototype.draw = function(parent) {
    if (this.hasLabel) {
      ...
      var w = Math.max(
        14,
        this.label.width +
          (this.shape === "string" || this.shape === "number-dropdown" ? 16 : 19)
      )
    } else {
    ...
    var h = (this.height = this.isRound || this.isColor ? 20 : 21)
